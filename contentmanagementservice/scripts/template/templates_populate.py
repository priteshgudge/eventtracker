...
from contentmanagementservice.scripts.template.data.email_templates import *
from contentmanagementservice.scripts.template.data.order_sms_templates import *
from contentmanagementservice.scripts.template.data.ticket_sms_templates import *
